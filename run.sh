...
sudo ./simulate_optack.py -d results/1 -n 1 -r 95 -t 30
echo "Experiment with 1 server finished"
sudo ./simulate_optack.py -d results/2 -n 2 -r 95 -t 30
echo "Experiment with 2 servers finished"
sudo ./simulate_optack.py -d results/4 -n 4 -r 95 -t 30
echo "Experiment with 4 servers finished"
sudo ./simulate_optack.py -d results/8 -n 8 -r 95 -t 30
...
do
    cd "$i"
    cd ../
    python total-bytes-per-sec.py $i/*.csv > $i.csv
done
