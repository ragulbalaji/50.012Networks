...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--iperf-runtime', type=int, default=10, help='Time to run the iperf clients.')
    parser.add_argument('-j', '--iperf-delayed-start', type=int, default=10,
